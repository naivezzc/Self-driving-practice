...
# Directory setting
parser.add_argument('--weights',type=str, default = './weights/unet_attn_50.pth')
...
parser.add_argument('--data_path', type=str, default = "/home/zzhang/ssd2/dataset/KITTI")
parser.add_argument('--use_dense_depth', default=False, action='store_true', help='using dense depth data for gradient loss')

# Optimizer and dataloader setting
parser.add_argument('-j', '--workers', default=0, type=int, metavar='N', help='number of data loading workers')
parser.add_argument('--seed', default=0, type=int, help='seed for random functions, and network initialization')
parser.add_argument('--epochs', default=20, type=int, metavar='N', help='number of total epochs to run')
parser.add_argument('--epoch_size', default=0, type=int, metavar='N',help='manual epoch size (will match datasets size if not set)')
